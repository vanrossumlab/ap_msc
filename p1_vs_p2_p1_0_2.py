...
data = dm.prepare_experiment_data("variable connection probabilities with 200 units p2", 
                                  experiment_data,
                                  "[part 2] - seed = 1, epochs = 20, interval = 5000 | 200 units in the hidden layer, multithreaded therefore multiple parts")
dm.save_data("data/p_connect_1_vs_p_connect_2/p1_vs_p2_200_units_p2", data)
