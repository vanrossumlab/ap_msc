...
base_path = 'data/'
file_path = 'ungated/50_units_various_p'
...
base_path = 'data/'
file_path = 'ungated/100_units_various_p'
...
base_path = 'data/'
file_path = 'ungated/150_units_various_p'
...
#plt.plot(p_connects2, energies2, linestyle='None', marker='.', markersize=marker_size, color=unitRGB(n_units, False), label='_nolegend_')
#plt.plot(p_connects2, energies2, linewidth=line_size, color=unitRGB(n_units, False), linestyle='dotted', label='_nolegend_')
plt.vlines(p1-0.0015, e1, e_max, linewidth=line_size, linestyle='dashed', color=unitRGB(n_units, False))
ax.annotate(xy=(p_connects1[np.where(energies1 == np.min(energies1))], e_max), xytext=(-160,-10), textcoords='offset points', text=str(n_units) + ": " +str(np.around((1-np.min(energies1)/energies1[-1])*100, 1))+"% Saved" , va='center', fontsize=26, color=unitRGB(n_units, True))
#plt.plot(p_connects2, energies2, linewidth=line_size, color=unitRGB(150, False), linestyle='dotted', label='_nolegend_')

base_path = 'data/'
file_path = 'ungated/200_units_various_p'
...
#plt.plot(p_connects2, energies2, linewidth=line_size, color=unitRGB(n_units, False), linestyle='dotted', label='_nolegend_')
plt.vlines(p1+0.0015, e1, e_max, linewidth=line_size, linestyle='dashed', color=unitRGB(n_units, False))
ax.annotate(xy=(p_connects1[np.where(energies1 == np.min(energies1))], e_max), xytext=(-65,-10), textcoords='offset points', text=str(n_units) + ": " +str(np.around((1-np.min(energies1)/energies1[-1])*100, 1))+"% Saved", va='center', fontsize=26, color=unitRGB(n_units, True))
base_path = 'data/'
...
#plt.plot(p_connects2, energies2, linewidth=line_size, color=unitRGB(n_units, False), linestyle='dotted', label='_nolegend_')
plt.vlines(p1, e1, e_max, linewidth=line_size, linestyle='dashed', color=unitRGB(n_units, False))
ax.annotate(xy=(p_connects1[np.where(energies1 == np.min(energies1))], e_max), xytext=(-15,10), textcoords='offset points', text=str(n_units) + ": " +str(np.around((1-np.min(energies1)/energies1[-1])*100, 1))+"% Saved", va='center', fontsize=26, color=unitRGB(n_units, True))
base_path = 'data/'
file_path = 'ungated/300_units_various_p'
...
plt.legend(['50 units', '100 units', '150 units', '200 units', '250 units', '300 units'], fontsize=22, loc='upper left')
plt.title('Ungated: Synaptic Density vs. Energy @ ' + str(np.around(acc, 1)) + "% Accuracy", fontsize=36)
plt.xlabel('Probability of Connection', fontsize=28)
plt.xticks(fontsize=24)
plt.ylabel('Energy /a.u.', fontsize=28)
plt.yticks(fontsize=24)

filename = 'ungated_' + str(np.around(acc, 1)) + '_accuracy_vs_p_connect' + '.svg'
plt.savefig(figure_path+filename)
filename = 'ungated_' + str(np.around(acc, 1)) + '_accuracy_vs_p_connect' +'.png'
plt.savefig(figure_path+filename)
plt.show()
plt.close()
