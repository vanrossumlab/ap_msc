...
data = dm.prepare_experiment_data("variable hidden units and connection probability p9", 
                                  experiment_data,
                                  "[part 9] - seed = 1, epochs = 20, interval = 5000 | single hidden layer, ideally I'd prefer smoother intervals, this is ran effectively multithreaded and therefore has multiple parts")
dm.save_data("data/n_hid_units_vs_p_connect/hidden_units_vs_connection_p9", data)
